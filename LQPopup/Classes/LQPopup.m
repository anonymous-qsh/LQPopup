...
LQPopupLayout LQPopupLayoutMake(LQPopupHorizontalLayout horizontal, LQPopupVerticalLayout vertical) {
  LQPopupLayout layout;
  layout.horizontal = horizontal;
  layout.vertical = vertical;
  return layout;
}

const LQPopupLayout LQPopupLayout_Center = { LQPopupHorizontalLayout_Center, LQPopupVerticalLayout_Center };

/**
 LQPopupLayout Value.
 Typically, you should not use this class directly.
 */
@interface NSValue (LQPopupLayout)
+ (NSValue *)valueWithLQPopupLayout:(LQPopupLayout)layout;
- (LQPopupLayout)LQPopupLayoutValue;
@end

/**
 Interate the views to find a LQPopup.
 */
@interface UIView (LQPopup)
///Iterate the subviews, if you find a LQPopup and block it.
- (void)containsPopupBlock:(void (^)(LQPopup *popup))block;
...
- (instancetype)initWithFrame:(CGRect)frame {
  ...
  if (self) {
    ...
    self.showType = LQPopupShowType_BounceInFromTop;
    self.dismissType = LQPopupDismissType_BounceOutToBottom;
    self.maskType = LQPopupMaskType_Dimmed;
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event {
  ...
  if (hitView == self) {
    ...
    return _maskType == LQPopupMaskType_None ? nil : hitView;
  } else {
...
+ (LQPopup *)popupWithContentView:(UIView *)contentView {
  LQPopup *popup = [[[self class] alloc] init];
...
+ (void)dismissAllPopups {
  ...
  for (UIWindow *window in windows) {
    [window containsPopupBlock:^(LQPopup * _Nonnull popup) {
...
- (void)show {
  [self showWithLayout:LQPopupLayout_Center];
}
...
- (void)showWithDuration:(NSTimeInterval)duration {
  [self showWithLayout:LQPopupLayout_Center duration:duration];
}

- (void)showWithLayout:(LQPopupLayout)layout duration:(NSTimeInterval)duration {
  NSDictionary *parameters = @{kParametersLayoutName: [NSValue valueWithLQPopupLayout:layout],
...
- (void)showWithParameters:(NSDictionary *)parameters {
  ...
  if (!_isBeingShown && !_isShowing && !_isBeingDismissed) {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
      ...
      if (strongSelf.maskType == LQPopupMaskType_Dimmed) {
      ...
      if (strongSelf.showType != LQPopupShowType_None) {
      ...
      if (centerValue) {
        ...
        LQPopupLayout layout = layoutValue ? [layoutValue LQPopupLayoutValue] : LQPopupLayout_Center;
        /// Layout of the horizontal.
        switch (layout.horizontal) {
        case LQPopupHorizontalLayout_Left:
          ...
          break;
        case LQPopupHoricontalLayout_Right:
          ...
          break;
        case LQPopupHorizontalLayout_LeftOfCenter:
        ...
        case LQPopupVerticalLayout_Top:
          ...
          break;
        case LQPopupVerticalLayout_AboveCenter:
      ...
      case LQPopupShowType_SlideInFromTop: {
        strongSelf.containerView.alpha = 1.0;
      ...
      case LQPopupShowType_SlideInFromBottom: {
        strongSelf.containerView.alpha = 1.0;
        strongSelf.containerView.transform = CGAffineTransformIdentity;
        CGRect startFrame = finalContainerFrame;
      ...
      case LQPopupShowType_SlideInFromLeft: {
        strongSelf.containerView.alpha = 1.0;
        strongSelf.containerView.transform = CGAffineTransformIdentity;
        CGRect startFrame = finalContainerFrame;
      ...
      case LQPopupShowType_SlideInFromRight: {
        strongSelf.containerView.alpha = 1.0;
        strongSelf.containerView.transform = CGAffineTransformIdentity;
        CGRect startFrame = finalContainerFrame;
      ...
      case LQPopupShowType_BounceInFromTop: {
        strongSelf.containerView.alpha = 1.0;
        strongSelf.containerView.transform = CGAffineTransformIdentity;
        CGRect startFrame = finalContainerFrame;
        startFrame.origin.y = - CGRectGetHeight(finalContainerFrame);
      ...
      case LQPopupShowType_BounceInFromBottom: {
        strongSelf.containerView.alpha = 1.0;
        strongSelf.containerView.transform = CGAffineTransformIdentity;
        CGRect startFrame = finalContainerFrame;
        startFrame.origin.y = CGRectGetHeight(self.bounds);
      ...
      case LQPopupShowType_BounceInFromLeft: {
        strongSelf.containerView.alpha = 1.0;
        strongSelf.containerView.transform = CGAffineTransformIdentity;
        CGRect startFrame = finalContainerFrame;
        startFrame.origin.x = - CGRectGetWidth(finalContainerFrame);
      ...
      case LQPopupShowType_BounceInFromRight: {
        strongSelf.containerView.alpha = 1.0;
        strongSelf.containerView.transform = CGAffineTransformIdentity;
        CGRect startFrame = finalContainerFrame;
        startFrame.origin.x = CGRectGetWidth(self.bounds);
...
- (void)dismiss:(BOOL)animated {
  if (_isShowing && !_isBeingDismissed) {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
      ...
      if (animated && strongSelf.showType != LQPopupShowType_None) {
      ...
      if (animated) {
        ...
        case LQPopupDismissType_SlideOutToTop: {
        ...
        case LQPopupDismissType_SlideOutToBottom: {
          CGRect finalFrame = strongSelf.containerView.frame;
        ...
        case LQPopupDismissType_SlideOutToLeft: {
          CGRect finalFrame = strongSelf.containerView.frame;
        ...
        case LQPopupDismissType_SlideOutToRight: {
          CGRect finalFrame = strongSelf.containerView.frame;
        ...
        case LQPopupDismissType_BounceOut: {
        ...
        case LQPopupDismissType_BounceOutToTop: {
        ...
        case LQPopupDismissType_BounceOutToBottom: {
          CGRect finalFrameA = strongSelf.containerView.frame;
        ...
        case LQPopupDismissType_BounceOutToLeft: {
          CGRect finalFrameA = strongSelf.containerView.frame;
        ...
        case LQPopupDismissType_BounceOutToRight: {
          CGRect finalFrameA = strongSelf.containerView.frame;
          finalFrameA.origin.x -= 20.0;
          CGRect finalFrameB = strongSelf.containerView.frame;
...
@implementation NSValue (LQPopupLayout)
+ (NSValue *)valueWithLQPopupLayout:(LQPopupLayout)layout {
  return [NSValue valueWithBytes:&layout objCType:@encode(LQPopupLayout)];
}
...
@implementation UIView (LQPopup)
- (void)containsPopupBlock:(void (^)(LQPopup *popup))block {
  for (UIView *subview in self.subviews) {
    if ([subview isKindOfClass:[LQPopup class]]) {
      block((LQPopup *)subview);
    } else {
...
- (void)dismissShowingPopup:(BOOL)animated {
  UIView *view = self;
  while (view) {
    if ([view isKindOfClass:[LQPopup class]]) {
      [(LQPopup *)view dismissAnimated:animated];
      break;
    }
    view = view.superview;
  }
